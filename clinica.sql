...
CREATE TABLE `sesiones` (
  ...
  `comentarios` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usuario` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `asiste` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `tipo_derivacion` VALUES (1,'Escuela'),(2,'Hospital'),(3,'Universidad'),(4,'Casa'),(5,'Clínica a hospital');
...
INSERT INTO `usuarios` VALUES (10,'admin@unap.cl','$2y$10$OzAc9gTRLDql6aHO94JKQ.n5Gq4YTkLc5DJuu9AreRHnQlkjaUBuK','2026-04-15 13:02:44','Javier González','admin'),(23,'caespinozar@unap.cl','$2y$10$StfyUBfq7MKhN0TEbkbAiuYWkFpkp0SNtHboO.XMkAIbID3Q4cugu','2026-04-16 19:44:32','Carolina Espinoza','usuario');
...
-- Dump completed on 2026-04-29 12:48:05
