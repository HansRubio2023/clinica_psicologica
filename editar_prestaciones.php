            ...
            <div class="col-lg-8 col-xl-6">
                ...
                <div class="text-center mb-4">
                    <h2 class="fw-bold text-primary mb-2">
                        <i class="fas fa-edit"></i> Editar Prestación
                    </h2>
                    <p class="text-muted">Complete todos los campos requeridos *</p>
                </div>

                <form method="POST" action="edit_prestaciones.php" id="formPrestacion">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="id_derivacion" id="selectDerivacion" required>
                            ...
                            while ($der = mysqli_fetch_assoc($query_der)) {
                                $selected = ($row['derivacion'] == $der['id_derivacion']) ? 'selected' : '';
                                echo "<option value='{$der['id_derivacion']}' $selected>{$der['nombre_institucion_derivacion']}</option>";
                            }
                            ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="comentarios" rows="3"
                            maxlength="250"><?php echo $row['comentarios']; ?></textarea>
                        <div class="textarea-counter">
                            <span id="contador2"><?php echo strlen($row['comentarios']); ?></span>/250 caracteres
                        </div>
                    </div>
